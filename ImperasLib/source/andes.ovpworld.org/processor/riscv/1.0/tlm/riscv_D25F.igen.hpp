...
class riscv_D25F : public tlmProcessor
{
  private:
  ...
  public:
    ...
    riscv_D25F(tlmModule &parent, sc_module_name name)
    ...
    riscv_D25F(tlmModule &parent, sc_module_name name, params p, Uns32 INSTRUCTIONWidth=56, Uns32 DATAWidth=56)
