...
class riscv_D45 : public tlmProcessor
{
  private:
  ...
  public:
    ...
    riscv_D45(tlmModule &parent, sc_module_name name)
    ...
    riscv_D45(tlmModule &parent, sc_module_name name, params p, Uns32 INSTRUCTIONWidth=56, Uns32 DATAWidth=56)
