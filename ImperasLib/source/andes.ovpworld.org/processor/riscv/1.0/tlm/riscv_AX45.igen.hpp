...
class riscv_AX45 : public tlmProcessor
{
  private:
  ...
  public:
    ...
    riscv_AX45(tlmModule &parent, sc_module_name name)
    ...
    riscv_AX45(tlmModule &parent, sc_module_name name, params p, Uns32 INSTRUCTIONWidth=56, Uns32 DATAWidth=56)
