...
class riscv_A45 : public tlmProcessor
{
  private:
  ...
  public:
    ...
    riscv_A45(tlmModule &parent, sc_module_name name)
    ...
    riscv_A45(tlmModule &parent, sc_module_name name, params p, Uns32 INSTRUCTIONWidth=34, Uns32 DATAWidth=34)
