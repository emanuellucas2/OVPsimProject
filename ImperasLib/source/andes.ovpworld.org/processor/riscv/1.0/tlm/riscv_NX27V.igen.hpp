...
class riscv_NX27V : public tlmProcessor
{
  private:
  ...
  public:
    ...
    riscv_NX27V(tlmModule &parent, sc_module_name name)
    ...
    riscv_NX27V(tlmModule &parent, sc_module_name name, params p, Uns32 INSTRUCTIONWidth=56, Uns32 DATAWidth=56)
