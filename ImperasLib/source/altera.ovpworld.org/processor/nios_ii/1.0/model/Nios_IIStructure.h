...
typedef enum Nios_IIDisableE {
    NIOS_II_ACTIVE      = 0x0000,    // processor active
    NIOS_II_RESET       = 0x0001,    // halted by reset high
    NIOS_II_STOP        = 0x0002,    // stopped by external debugger
} Nios_IIDisable;
