...
// Message prefix
//
#define CPU_PREFIX "NIOS_II_NEWLIB"
...
static VMIOS_CONSTRUCTOR_FN(constructor) {
    ...
    // first three argument registers (standard ABI)
    object->args[0] = vmiosGetRegDesc(processor, "r4");
    object->args[1] = vmiosGetRegDesc(processor, "r5");
    object->args[2] = vmiosGetRegDesc(processor, "r6");

    // return register (standard ABI)
    object->resultReg = vmiosGetRegDesc(processor, "r2");
