...
iadddocumentation -name Description -text "This is the generic version based on the RiscV Specification. Vendor-specific variations are available (e.g. Andes NCEPLIC100, SiFive PLIC)."

iadddocumentation -name Limitations -text "None"

iadddocumentation -name Reference   -text "RISC-V Platform-Level Interrupt Controller Version 1.0, 09/2021 (https://github.com/riscv/riscv-plic-spec/tree/832ec217197a59a375c5372c630e73fd954597bf)"
...
imodeladdformal   -name num_targets -type Uns32    -min 1    -max 15872 -defaultvalue 1
iadddocumentation -name num_targets -text "Number of Output Interrupt Targets, Hart/Context"

imodeladdformal   -name num_priorities -type Uns32 -min 1    -max -1  -defaultvalue 7
