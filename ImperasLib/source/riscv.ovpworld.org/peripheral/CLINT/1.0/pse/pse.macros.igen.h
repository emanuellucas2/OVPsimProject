...
#define PORT0_MTIME_MTIMECMP0_POFFSET   0x0
#define PORT0_MTIME_MTIMECMP0           (PORT0 + PORT0_MTIME_POFFSET + PORT0_MTIME_MTIMECMP0_POFFSET)

#define PORT0_MTIME_MTIME_POFFSET       0x7ff8
#define PORT0_MTIME_MTIME               (PORT0 + PORT0_MTIME_POFFSET + PORT0_MTIME_MTIME_POFFSET)
