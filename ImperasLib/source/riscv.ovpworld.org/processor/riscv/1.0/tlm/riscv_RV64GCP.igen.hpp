...
class riscv_RV64GCP : public tlmProcessor
{
  private:
    params paramsForProc(params p) {
        p.set("variant", "RV64GCP");
        return p;
    }
  ...
  public:
    ...
    riscv_RV64GCP(tlmModule &parent, sc_module_name name)
    ...
    riscv_RV64GCP(tlmModule &parent, sc_module_name name, params p, Uns32 INSTRUCTIONWidth=56, Uns32 DATAWidth=56)
