...
class riscv_RV32GCP : public tlmProcessor
{
  private:
    params paramsForProc(params p) {
        p.set("variant", "RV32GCP");
        return p;
    }
  ...
  public:
    ...
    riscv_RV32GCP(tlmModule &parent, sc_module_name name)
    ...
    riscv_RV32GCP(tlmModule &parent, sc_module_name name, params p, Uns32 INSTRUCTIONWidth=34, Uns32 DATAWidth=34)
