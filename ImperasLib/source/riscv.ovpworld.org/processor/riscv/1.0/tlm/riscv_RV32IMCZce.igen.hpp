...
class riscv_RV32IMCZce : public tlmProcessor
{
  private:
    params paramsForProc(params p) {
        p.set("variant", "RV32IMCZce");
        return p;
    }
  ...
  public:
    ...
    riscv_RV32IMCZce(tlmModule &parent, sc_module_name name)
    ...
    riscv_RV32IMCZce(tlmModule &parent, sc_module_name name, params p, Uns32 INSTRUCTIONWidth=34, Uns32 DATAWidth=34)
