...
ihwaddclp -allargs -usagemessage "Basic Usage. <Linux Xilinx ML505 executable> --kernel <kernel image> --uartconsole"
ihwaddclparg -name kernel       -type stringvar -group "user platform config" -description "The Linux Kernel image e.g. vmlinux"
ihwaddclparg -name uartconsole  -type boolvar   -group "user platform config" -description "Open a console terminal on the UART"
ihwaddclparg -name uartport     -type uns64var  -group "user platform config" -description "Set the port number to open on the UART and wait for connection"
