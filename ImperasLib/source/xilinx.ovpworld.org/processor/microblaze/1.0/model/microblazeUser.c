...
void microblazeFillMSR(microblazeP microblaze) {
    microblaze->SPR_MSR.CC = microblaze->FLG_CC;
    microblaze->SPR_MSR.C  = microblaze->FLG_CC;
}
...
void microblazeEmptyMSR(microblazeP microblaze) {
    microblaze->FLG_CC = microblaze->SPR_MSR.C;
}
...
void microblazeFillFSR(microblazeP microblaze) {
    ...
    microblaze->SPR_FSR.IO = microblaze->FLG_FP.f.I;  // invalid operation flag
    microblaze->SPR_FSR.DZ = microblaze->FLG_FP.f.Z;  // divide-by-zero flag
    microblaze->SPR_FSR.OF = microblaze->FLG_FP.f.O;  // overflow flag
    microblaze->SPR_FSR.UF = microblaze->FLG_FP.f.U;  // underflow flag

    // Needs special handling - not a VMI flag
    microblaze->SPR_FSR.DO = microblaze->FLG_DO == 0 ? 0 : 1;  // Denormal Operand
}
...
void microblazeEmptyFSR(microblazeP microblaze) {
    ...
    microblaze->FLG_FP.f.I = microblaze->SPR_FSR.IO;   // invalid operation flag
    microblaze->FLG_FP.f.Z = microblaze->SPR_FSR.DZ;   // divide-by-zero flag
    microblaze->FLG_FP.f.O = microblaze->SPR_FSR.OF;   // overflow flag
    microblaze->FLG_FP.f.U = microblaze->SPR_FSR.UF;   // underflow flag

    // Needs special handling - not a VMI flag
    microblaze->FLG_DO = microblaze->SPR_FSR.DO;       // Denormal Operand
}
