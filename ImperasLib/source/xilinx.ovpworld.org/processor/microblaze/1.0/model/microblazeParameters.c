...
static vmiParameter formals[] = {
    ...
    VMI_UNS32_PARAM_SPEC(microblazeParamValues, C_BASE_VECTORS, 0x0, 0x0, 0xffffff80, "Location of Microblaze Vectors"),
    ...
    VMI_BOOL_PARAM_SPEC(microblazeParamValues,  C_D_LMB, 1, "Data side LMB interface"),
    ...
    VMI_BOOL_PARAM_SPEC(microblazeParamValues, C_I_LMB, 1, "Instruction side LMB interface"),
    VMI_UNS32_PARAM_SPEC(microblazeParamValues, C_M_AXI_DP_EXCLUSIVE_ACCESS, 0, 0, 1, "Data Peripheral AXI Interface uses AXI4 protocol, with support for exclusive access"),
    VMI_UNS32_PARAM_SPEC(microblazeParamValues, C_M_AXI_DC_EXCLUSIVE_ACCESS, 0, 0, 1, "Data Cache AXI Interface uses AXI4 protocol, with support for exclusive access"),
    VMI_BOOL_PARAM_SPEC(microblazeParamValues, C_USE_BARREL, 0, "Include barrel shifter"),
    VMI_BOOL_PARAM_SPEC(microblazeParamValues, C_USE_DIV, 0, "Include hardware divider"),
    ...
    VMI_BOOL_PARAM_SPEC(microblazeParamValues, C_USE_MSR_INSTR, 1, "Enable use of instructions: integer MSRSET and MSRCLR"),
    VMI_BOOL_PARAM_SPEC(microblazeParamValues, C_USE_PCMP_INSTR, 1, "Enable use of instructions: integer CLZ, PCMPBF, PCMPEQ, and PCMPNE"),
    VMI_UNS32_PARAM_SPEC(microblazeParamValues, C_USE_REORDER_INSTR, 0, 0, 1, "Enable use of instructions: LBUR, LHUR, LWR, SBR. SHR, SWR, SWAPB, SWAPH"),
    VMI_BOOL_PARAM_SPEC(microblazeParamValues, C_UNALIGNED_EXCEPTIONS, 0, "Enable exception handling for unaligned data accesses"),
    VMI_BOOL_PARAM_SPEC(microblazeParamValues, C_ILL_OPCODE_EXCEPTION, 0, "Enable exception handling for illegal op-code"),
    ...
    VMI_BOOL_PARAM_SPEC(microblazeParamValues, C_DIV_ZERO_EXCEPTION, 0, "Enable exception handling for division by zero or division overflow"),
    VMI_BOOL_PARAM_SPEC(microblazeParamValues, C_FPU_EXCEPTION, 0, "Enable exception handling for hardware floating point unit exceptions"),
    VMI_BOOL_PARAM_SPEC(microblazeParamValues, C_OPCODE_0x0_ILLEGAL, 0, "Detect opcode 0x0 as an illegal instruction"),
    VMI_BOOL_PARAM_SPEC(microblazeParamValues, C_FSL_EXCEPTION, 0, "Enable exception handling for Stream Links"),
    ...
    VMI_BOOL_PARAM_SPEC(microblazeParamValues, C_DEBUG_ENABLED, 0, "MDM Debug interface"),
    ...
    VMI_BOOL_PARAM_SPEC(microblazeParamValues, C_USE_EXTENDED_FSL_INSTR, 0, "Enable use of extended integer stream instructions"),
