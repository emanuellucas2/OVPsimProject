...
typedef enum microblazeDisableE {
    MBD_ACTIVE      = 0x0000,    // processor active
    MBD_RESET       = 0x0001,    // halted by reset high
    MBD_STOP        = 0x0002,    // stopped by external debugger
} microblazeDisable;
...
typedef struct microblazeS {
    ...
    TYPE_SPR_PVR12 SPR_PVR12, SPR_PVR12_rmask, SPR_PVR12_wmask;
    ...
    //
    Bool  reservation;
    Uns32 reservation_addr;
    Uns32 reservation_length;

    // Psuedo-register to hold floating point sticky flags in VMI format
    vmiFPFlags FLG_FP;
    Uns8       FLG_DO;

    // Psuedo-register to handle a debug halt
    microblazeDisable disable;
    ...
    struct {
        ...
        Uns32 C_I_AXI;
        Uns32 C_I_LMB;
        Uns32 C_M_AXI_DP_EXCLUSIVE_ACCESS;
        Uns32 C_M_AXI_DC_EXCLUSIVE_ACCESS;
        Uns32 C_USE_BARREL;
        Uns32 C_USE_DIV;
        Uns32 C_USE_HW_MUL;
        Uns32 C_USE_FPU;
...
#define MICROBLAZE_RESERVATION_BITS (sizeof(Bool) * 8)
#define MICROBLAZE_RESERVATION_RD MICROBLAZE_CPU_REG(reservation)
#define MICROBLAZE_RESERVATION_WR MICROBLAZE_CPU_REG(reservation)

#define MICROBLAZE_RESERVATION_ADDR_BITS (sizeof(Uns32) * 8)
#define MICROBLAZE_RESERVATION_ADDR_RD MICROBLAZE_CPU_REG(reservation_addr)
#define MICROBLAZE_RESERVATION_ADDR_WR MICROBLAZE_CPU_REG(reservation_addr)

#define MICROBLAZE_RESERVATION_LENGTH_BITS (sizeof(Uns32) * 8)
#define MICROBLAZE_RESERVATION_LENGTH_RD MICROBLAZE_CPU_REG(reservation_length)
#define MICROBLAZE_RESERVATION_LENGTH_WR MICROBLAZE_CPU_REG(reservation_length)
...
#define MICROBLAZE_RESERVATION_CONST MICROBLAZE_CPU_REG_CONST(reservation)

#define MICROBLAZE_RESERVATION_ADDR_CONST MICROBLAZE_CPU_REG_CONST(reservation_addr)

#define MICROBLAZE_RESERVATION_LENGTH_CONST MICROBLAZE_CPU_REG_CONST(reservation_length)
