...
iadddocumentation  \
    -name Description  \
    -text "Microblaze LogiCORE IP XPS MCH EMC Multi Channel External Memory Controller"
...
iadddocumentation -name Reference -text "DS575 June 22, 2010 v3.01a"

imodeladdbusslaveport  -name plb -mustbeconnected -size 0x2000000
imodeladdaddressblock  -name REG -port plb -size 0x2000000 -offset 0 -width 32
...
######################################## Temporary ######################################
imodeladdlocalmemory  -name buffer -addressblock plb/REG -size 0x2000000 \
