...
iadddocumentation  \
    -name Description  \
    -text "Microblaze Multi-Port Memory Controller"
...
iadddocumentation -name Reference -text "DS643 March 1, 2011 v6.03.a"

imodeladdbusslaveport  -name plb -mustbeconnected -size 0x80
imodeladdaddressblock  -name REG -port plb -size 0x80 -offset 0 -width 32
...
######################################## Temporary ######################################
imodeladdlocalmemory  -name buffer -addressblock plb/REG -size 0x80 \
