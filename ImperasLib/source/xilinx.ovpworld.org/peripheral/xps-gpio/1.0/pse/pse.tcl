...
iadddocumentation  \
    -name Description  \
    -text "Microblaze General Purpose IO"
...
iadddocumentation -name Reference -text "DS569 December 2, 2009 v2.00a"

imodeladdbusslaveport  -name plb -mustbeconnected -size 0x10000
imodeladdaddressblock  -name REG -port plb -size 0x10000 -offset 0 -width 32
...
######################################## Temporary ######################################
imodeladdlocalmemory  -name buffer -addressblock plb/REG -size 0x10000 \
