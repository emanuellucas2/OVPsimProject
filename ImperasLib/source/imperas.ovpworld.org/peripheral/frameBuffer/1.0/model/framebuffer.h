...
struct QFrameBuffer {
    ...
    // NATIVE POINTERS (common footprint on 32-bit and 64-bit hosts)
    union {void* pixels; Uns64 _pse_h1;}; /* pixel buffer */
    union {void* extra;  Uns64 _pse_h2;}; /* extra data that is handled by the
