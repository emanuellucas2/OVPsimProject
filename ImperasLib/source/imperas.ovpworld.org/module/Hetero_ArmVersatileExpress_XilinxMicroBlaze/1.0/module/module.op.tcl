...
set desc "This platform instances an ARM VersatileExpress with a Xilinx Microblaze based sub-system"

set limit "Peripherals are modeled to the extent required to boot and run Operating Systems such as Linux."

set ref "ARM Development Boards VersatileExpress"

# Setup variables for platform info
set vendor  imperas.ovpworld.org
set library module
set name    Hetero_ArmVersatileExpress_XilinxMicroBlaze
set version 1.0
