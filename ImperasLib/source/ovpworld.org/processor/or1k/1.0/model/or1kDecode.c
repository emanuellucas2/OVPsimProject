...
typedef enum constSpecE {
    ...
    C_U2,                       // constant in bits 25:21,10:0
...
typedef struct opAttrsS {
    ...
    octiaInstructionClass class;        // instruction class
...
//
// Attributes for instructions like SYS
//
#define ATTR_SET_SYS(_NAME, _OPCODE, _DECODE) \
    [OR1K_IT_##_NAME] = {           \
        member : #_NAME,            \
        opcode : _OPCODE,           \
        format : FMT_NONE,          \
...
//
// Attributes for instructions like MTSPR
//
#define ATTR_SET_MTSPR(_NAME, _OPCODE, _DECODE) \
    [OR1K_IT_##_NAME] = {           \
        member : #_NAME,            \
        opcode : _OPCODE,           \
        format : FMT_R1_R2_UIMM,    \
        class  : OCL_IC_SYSREG,     \
        decode : _DECODE,           \
        r1     : R_A,               \
        r2     : R_B,               \
...
//
// Attributes for instructions like MFSPR
//
#define ATTR_SET_MFSPR(_NAME, _OPCODE, _DECODE) \
    [OR1K_IT_##_NAME] = {           \
        member : #_NAME,            \
        opcode : _OPCODE,           \
        format : FMT_R1_R2_UIMM,    \
...
const static opAttrs attrsArray[OR1K_IT_LAST+1] = {
    ...
    ATTR_SET_MTSPR(MTSPR, "mtspr", "|110000..........................|"),
    ATTR_SET_MFSPR(MFSPR, "mfspr", "|101101..........................|"),

    // handle sys and rfe instructions
    ATTR_SET_SYS  (SYS,   "sys",   "|0010000000000000................|"),
    ATTR_SET_SYS  (RFE,   "rfe",   "|001001..........................|"),
