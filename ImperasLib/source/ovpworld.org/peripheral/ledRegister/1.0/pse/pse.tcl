...
iadddocumentation  -name Description  \
                   -text "Simple test peripheral providing a register that may be used to toggle LED outputs."
...
set registers { led_set   0x00  rw  0 readLed setLed
                led_reset 0x01  rw  0 readLed resetLed
	        led_data  0x04  rw  0 readLed writeLed
}
...
set defaultLEDS 4
imodeladdformal   -name availableLEDS -type uns32  -min 0 -defaultvalue ${defaultLEDS} -max 8
iadddocumentation -name Description -text "How many LEDs to display (default ${defaultLEDS})"
