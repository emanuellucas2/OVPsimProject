...
set name    KinetisOSC
set version 1.0
set desc "Model of the OSC peripheral used on the Freescale Kinetis platform"
...
imodeladdaddressblock -name ab     -size 0x01 -port bport1 -width 8
...
set registers { 
CR              0x00 rw - - - - 0x00 0xaf "OSC Control Register, offset: 0x0 "
}
...
imodeladdfield -mmregister $addBlock/CR -name ERCLKEN -bitoffset 7  -width 1
imodeladdfield -mmregister $addBlock/CR -name EREFSTEN -bitoffset 5  -width 1
imodeladdfield -mmregister $addBlock/CR -name SC16P -bitoffset 0  -width 1
imodeladdfield -mmregister $addBlock/CR -name SC2P -bitoffset 3  -width 1
imodeladdfield -mmregister $addBlock/CR -name SC4P -bitoffset 2  -width 1
imodeladdfield -mmregister $addBlock/CR -name SC8P -bitoffset 1  -width 1
