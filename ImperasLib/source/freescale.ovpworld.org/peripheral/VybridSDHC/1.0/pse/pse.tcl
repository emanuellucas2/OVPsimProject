...
set name    VybridSDHC
set version 1.0
set desc "Model of the SDHC peripheral used on the Freescale Vybrid platform"
...
WML             0x44 rw - - - - 0x08100810 0x1fff1fff "Watermark Level Register, offset: 0x44 "	
...
imodeladdfield -mmregister $addBlock/PRSSTAT -name CDPL -bitoffset 18  -width 1
...
imodeladdfield -mmregister $addBlock/PRSSTAT -name WPSPL -bitoffset 19  -width 1
...
imodeladdfield -mmregister $addBlock/WML -name RDBRSTLEN -bitoffset 8  -width 5
