...
set name    KinetisDMAC
set version 1.0
set desc "Freescale Kinetis Direct Memory Access Controller"
...
imodeladdaddressblock -name ab     -size 0x4     -port bport1 -width 32 

set addBlock     "bport1/ab" 

#   name      offset ac readFn    writeFn   viewFn   user reset      mask       description  
set registers {
	cr        0x0    rw -         -         -         -   0x00000000 0x000000f6 "DMAC Control Register"
}
