...
set name    VybridCCM
set version 1.0
set desc "Freescale Clock Controller Module"
set limitations "Only models status register read"
...
imodeladdaddressblock -name ab     -size 0x8     -port bport1 -width 32

set addBlock     "bport1/ab"

#   name          offset ac readFn    writeFn   viewFn   user reset          mask description   
set registers {
	csr           0x4    r  -         -         -         -    0x00000030    -    "CCM Status Register"
}
