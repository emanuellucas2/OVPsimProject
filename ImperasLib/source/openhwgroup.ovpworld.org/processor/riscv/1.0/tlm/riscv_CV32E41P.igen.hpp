...
class riscv_CV32E41P : public tlmProcessor
{
  private:
    params paramsForProc(params p) {
        p.set("variant", "CV32E41P");
        return p;
    }
  ...
  public:
    ...
    riscv_CV32E41P(tlmModule &parent, sc_module_name name)
    ...
    riscv_CV32E41P(tlmModule &parent, sc_module_name name, params p, Uns32 INSTRUCTIONWidth=34, Uns32 DATAWidth=34)
