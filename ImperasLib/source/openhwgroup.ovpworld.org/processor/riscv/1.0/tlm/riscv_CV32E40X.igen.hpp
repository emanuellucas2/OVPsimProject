...
class riscv_CV32E40X : public tlmProcessor
{
  ...
  public:
    ...
    tlmNetInputPort      LoadBusFaultNMI;
    tlmNetInputPort      StoreBusFaultNMI;
    tlmNetInputPort      InstructionBusFault;
    ...
    , LoadBusFaultNMI(parent, this, "LoadBusFaultNMI")
    , StoreBusFaultNMI(parent, this, "StoreBusFaultNMI")
    , InstructionBusFault(parent, this, "InstructionBusFault")
    {
    }

    riscv_CV32E40X(tlmModule &parent, sc_module_name name, params p, Uns32 INSTRUCTIONWidth=34, Uns32 DATAWidth=34)
