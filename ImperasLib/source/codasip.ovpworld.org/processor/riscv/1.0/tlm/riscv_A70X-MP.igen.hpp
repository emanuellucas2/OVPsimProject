...
class riscv_A70X_MP : public tlmProcessor
{
  private:
    params paramsForProc(params p) {
        p.set("variant", "A70X-MP");
        return p;
    }
  ...
  public:
    ...
    riscv_A70X_MP(tlmModule &parent, sc_module_name name)
    ...
    riscv_A70X_MP(tlmModule &parent, sc_module_name name, params p, Uns32 INSTRUCTIONWidth=56, Uns32 DATAWidth=56)
