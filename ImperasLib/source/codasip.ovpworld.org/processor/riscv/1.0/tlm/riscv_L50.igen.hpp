...
class riscv_L50 : public tlmProcessor
{
  private:
  ...
  public:
    ...
    riscv_L50(tlmModule &parent, sc_module_name name)
    ...
    riscv_L50(tlmModule &parent, sc_module_name name, params p, Uns32 INSTRUCTIONWidth=34, Uns32 DATAWidth=34)
