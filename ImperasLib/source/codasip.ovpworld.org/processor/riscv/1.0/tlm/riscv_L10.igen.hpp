...
class riscv_L10 : public tlmProcessor
{
  private:
  ...
  public:
    ...
    riscv_L10(tlmModule &parent, sc_module_name name)
    ...
    riscv_L10(tlmModule &parent, sc_module_name name, params p, Uns32 INSTRUCTIONWidth=34, Uns32 DATAWidth=34)
