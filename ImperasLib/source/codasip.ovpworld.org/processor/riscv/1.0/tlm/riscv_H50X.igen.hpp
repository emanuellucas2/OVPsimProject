...
class riscv_H50X : public tlmProcessor
{
  private:
  ...
  public:
    ...
    riscv_H50X(tlmModule &parent, sc_module_name name)
    ...
    riscv_H50X(tlmModule &parent, sc_module_name name, params p, Uns32 INSTRUCTIONWidth=56, Uns32 DATAWidth=56)
