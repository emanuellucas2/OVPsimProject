...
class riscv_L30F : public tlmProcessor
{
  private:
  ...
  public:
    ...
    riscv_L30F(tlmModule &parent, sc_module_name name)
    ...
    riscv_L30F(tlmModule &parent, sc_module_name name, params p, Uns32 INSTRUCTIONWidth=34, Uns32 DATAWidth=34)
