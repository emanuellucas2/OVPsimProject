...
class riscv_A71X : public tlmProcessor
{
  private:
  ...
  public:
    ...
    riscv_A71X(tlmModule &parent, sc_module_name name)
    ...
    riscv_A71X(tlmModule &parent, sc_module_name name, params p, Uns32 INSTRUCTIONWidth=56, Uns32 DATAWidth=56)
