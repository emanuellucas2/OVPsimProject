...
PPM_REG_WRITE_CB(PS_CR_wcb) {
    // YOUR CODE HERE (PS_CR_wcb)
    bp1_REG_data.PS_CR.value = data;
    INFO;
}

PPM_REG_WRITE_CB(PS_PCDR_wcb) {
    // YOUR CODE HERE (PS_PCDR_wcb)
    bp1_REG_data.PS_PCDR.value = data;
    INFO;
}

PPM_REG_WRITE_CB(PS_PCER_wcb) {
    // YOUR CODE HERE (PS_PCER_wcb)
    bp1_REG_data.PS_PCER.value = data;
    INFO;
}
