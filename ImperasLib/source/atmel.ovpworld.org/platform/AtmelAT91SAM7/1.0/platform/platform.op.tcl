...
iadddocumentation -name Description -text "Simple platform of Atmel AT91 ARM7TDMI based system"
...
ihwaddnet -instancename US0IRQ
ihwaddnet -instancename US1IRQ
ihwaddnet -instancename TC0IRQ
ihwaddnet -instancename TC1IRQ
ihwaddnet -instancename TC2IRQ
ihwaddnet -instancename WDIRQ
ihwaddnet -instancename PIOIRQ
...
ihwaddclp -allargs -usagemessage "Basic Usage. <Atmel AT91SAM7 executable> --kernel <uCLinux kernel image>"
ihwaddclparg -name kernel       -type stringvar -group "user platform config" -description "The Linux Kernel image e.g. linux"
ihwaddclparg -name uartport     -type uns64var  -group "user platform config" -description "Set the port number to open on the UART and wait for connection, by default a console will be opened."
