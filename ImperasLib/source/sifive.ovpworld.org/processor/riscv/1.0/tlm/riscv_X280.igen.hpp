...
class riscv_X280 : public tlmProcessor
{
  private:
  ...
  public:
    ...
    riscv_X280(tlmModule &parent, sc_module_name name)
    ...
    riscv_X280(tlmModule &parent, sc_module_name name, params p, Uns32 INSTRUCTIONWidth=56, Uns32 DATAWidth=56)
