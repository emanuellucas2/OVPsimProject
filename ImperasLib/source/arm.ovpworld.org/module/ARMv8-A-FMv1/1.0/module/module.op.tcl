...
# The Ethernet device can connect to a physical Ethernet connection within the simulation implemented using packetNet
ihwaddpacketnet  -instancename phyEthernet
ihwconnect       -instancename eth0 -packetnetport phy -packetnet phyEthernet
...
ihwsetparameter  -handle       uart0  -name xchars             -value 120       -type uns32
ihwsetparameter  -handle       uart0  -name ychars             -value  40       -type uns32
...
ihwaddnet        -instancename directReadN
ihwconnect       -instancename uart3  -net directReadN  -netport DirectRead
ihwaddnet        -instancename directWriteN
ihwconnect       -instancename uart3  -net directWriteN  -netport DirectWrite

# 0x1c130000    0x1c1301ff      Virtio block device 
ihwaddperipheral -instancename vbd0 -type VirtioBlkMMIO -vendor ovpworld.org 
ihwconnect       -instancename vbd0 -bus pBus -busmasterport dma    -loaddress 0 -hiaddress 0xffffffffff
...
# Map unused space in ARM memory map 0x05000000 to 0x0500ffff to bottom of bus port 
ihwaddbridge  -instancename pBusBridge
ihwconnect    -instancename pBusBridge -busslaveport  sp1 -bus pBus       -loaddress 0x05000000 -hiaddress 0x0500ffff
...
ihwaddnetport -instancename directReadP
ihwconnect    -netport directReadP -net directReadN
ihwaddnetport -instancename directWriteP
ihwconnect    -netport directWriteP -net directWriteN
  
# ethernet PHY port
ihwaddpacketnetport -instancename phyEthernetPort
ihwconnect -packetnet phyEthernet -packetnetport phyEthernetPort
