...
iadddocumentation -name Description -text "ARM PL341 Dynamic Memory Controller Registers"
...
iadddocumentation -name Reference   -text "ARM CoreLink DDR2 Dynamic Memory Controller (DMC-341) Technical Reference Manual (ARM DDI 0418)"
...
#   name            offset ac   descr  readFn            writeFn     bits

set registers {
    StatusReg       0x000   r    ""    readStatusReg     -           -
    UserStatusReg   0x300   r    ""    readUserStatusReg -           -
