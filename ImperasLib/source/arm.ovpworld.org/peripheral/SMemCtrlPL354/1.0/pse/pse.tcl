...
iadddocumentation -name Description -text "PL354 Static Memory Controller"
...
iadddocumentation -name Reference   -text "ARM PrimeCell Static Memory Controller (PL350 series) Technical Reference Manual (ARM DDI 0380)"
