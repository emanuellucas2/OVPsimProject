...
iadddocumentation -name Description -text "Versatile Express Serial Bus DVI Registers"
...
iadddocumentation -name Reference   -text "ARM Motherboard Express ATX V2M-P1 Technical Reference Manual(ARM DUI 0447G), Section 4.5.8 Two-wire serial bus interface, SBCon"
