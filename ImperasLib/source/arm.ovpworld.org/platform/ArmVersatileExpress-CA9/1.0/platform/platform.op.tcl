...
ihwaddnet -instancename tzpcdecprot1_4
ihwaddnet -instancename tzpcdecprot0_0
ihwaddnet -instancename tzpcdecprot0_1
ihwaddnet -instancename tzpcdecprot0_2
ihwaddnet -instancename tzpcdecprot0_4
ihwaddnet -instancename tzpcdecprot0_5
ihwaddnet -instancename tzpcdecprot0_9
ihwaddnet -instancename tzpcdecprot0_10
...
proc mapNonSecure { instancename loaddress size {enable ""} } {
    ...
    if {$enable eq ""} {
        ...
        ihwconnect   -instancename $instancename -bus tzBus -busslaveport  "sp" -loaddress $loaddressNS -hiaddress $hiaddressNS
        ihwconnect   -instancename $instancename -bus pBus  -busmasterport "mp" -loaddress $loaddress   -hiaddress $hiaddress
        ...
        ihwsetparameter    -handle $instancename -name mpLoAddress -value $loaddress    -type uns64
        ihwsetparameter    -handle $instancename -name spLoAddress -value $loaddressNS  -type uns64
...
ihwconnect       -instancename sysRegs   -bus pBus  -busslaveport  bport1 -loaddress 0x10000000 -hiaddress 0x10000fff
...
ihwconnect       -instancename sysCtrl -bus pBus  -busslaveport  bport1 -loaddress 0x10001000 -hiaddress 0x10001fff
mapNonSecure     sysCtrlNS 0x10001000 0x1000

# 0x10002000    0x10002fff      serial bus PCI
ihwaddperipheral -instancename sbpci0 -vendor ovpworld.org -type trap
ihwconnect       -instancename sbpci0 -busslaveport bport1 -bus pBus
ihwsetparameter  -handle       sbpci0 -name portAddress -value 0x10002000 -type uns32

# 0x10004000    0x10004fff      PL041 audio
ihwaddperipheral -instancename aac1 -type AaciPL041 -vendor arm.ovpworld.org
ihwconnect       -instancename aac1 -bus pBus  -busslaveport  bport1 -loaddress 0x10004000 -hiaddress 0x10004fff
...
ihwconnect       -instancename mmc1  -bus pBus  -busslaveport  bport1 -loaddress 0x10005000 -hiaddress 0x10005fff
...
ihwconnect       -instancename kb1 -bus pBus  -busslaveport  bport1 -loaddress 0x10006000 -hiaddress 0x10006fff
...
ihwconnect       -instancename ms1 -bus pBus  -busslaveport  bport1 -loaddress 0x10007000 -hiaddress 0x10007fff
...
ihwconnect       -instancename uart0  -bus pBus  -busslaveport  bport1 -loaddress 0x10009000 -hiaddress 0x10009fff
...
ihwconnect       -instancename uart1  -bus pBus  -busslaveport  bport1 -loaddress 0x1000a000 -hiaddress 0x1000afff
...
ihwconnect       -instancename uart2  -bus pBus  -busslaveport  bport1 -loaddress 0x1000b000 -hiaddress 0x1000bfff
...
ihwconnect       -instancename uart3  -bus pBus  -busslaveport  bport1 -loaddress 0x1000c000 -hiaddress 0x1000cfff
...
ihwconnect       -instancename wdt1 -bus pBus  -busslaveport  bport1 -loaddress 0x1000f000 -hiaddress 0x1000ffff
...
ihwconnect       -instancename timer01 -bus pBus  -busslaveport  bport1 -loaddress 0x10011000 -hiaddress 0x10011fff
...
ihwconnect       -instancename timer23 -bus pBus  -busslaveport  bport1 -loaddress 0x10012000 -hiaddress 0x10012fff
...
ihwconnect       -instancename dvi1 -bus pBus  -busslaveport  bport1 -loaddress 0x10016000 -hiaddress 0x10016fff
...
ihwconnect       -instancename rtc1 -bus pBus  -busslaveport  bport1 -loaddress 0x10017000 -hiaddress 0x10017fff
...
ihwconnect       -instancename clcd -bus pBus  -busslaveport  bport1 -loaddress 0x1001f000 -hiaddress 0x1001ffff
...
ihwconnect       -instancename lcd1 -bus pBus  -busslaveport  bport1 -loaddress 0x10020000 -hiaddress 0x10020fff
...
ihwconnect       -instancename dmc1 -bus pBus  -busslaveport  bport1 -loaddress 0x100e0000 -hiaddress 0x100e0fff
...
ihwconnect       -instancename smc1 -bus pBus  -busslaveport  bport1 -loaddress 0x100e1000 -hiaddress 0x100e1fff
mapNonSecure     smc1NS 0x100e1000 0x1000 tzpcdecprot0_1

# 0x100e2000    0x100e2fff      System Configuration Controller - Dummy
ihwaddperipheral -instancename scc1 -vendor ovpworld.org -type trap
ihwconnect       -instancename scc1 -busslaveport bport1 -bus pBus
ihwsetparameter  -handle       scc1 -name portAddress -value 0x100e2000 -type uns32
...
ihwconnect       -instancename timer45 -bus pBus  -busslaveport  bport1 -loaddress 0x100e4000 -hiaddress 0x100e4fff
...
ihwconnect       -instancename wdt2 -bus pBus  -busslaveport  bport1 -loaddress 0x100e5000 -hiaddress 0x100e5fff
...
ihwconnect       -instancename tzpc -bus pBus -busslaveport bport1 -loaddress 0x100e6000 -hiaddress 0x100e6fff
...
ihwconnect       -instancename gpio0 -busslaveport bport1 -bus pBus
...
ihwaddperipheral -instancename faxi1 -vendor ovpworld.org -type trap
ihwconnect       -instancename faxi1 -busslaveport bport1 -bus pBus
ihwsetparameter  -handle       faxi1 -name portAddress -value 0x100e9000 -type uns32
mapNonSecure     faxi1NS 0x100e9000 0x1000 tzpcdecprot0_9

# 0x100ea000    0x100eafff      PL301 'Slow' AXI matrix - Dummy
ihwaddperipheral -instancename saxi1 -vendor ovpworld.org -type trap
ihwconnect       -instancename saxi1 -busslaveport bport1 -bus pBus
ihwsetparameter  -handle       saxi1 -name portAddress -value 0x100ea000 -type uns32
...
ihwconnect       -instancename l2regs -bus pBus  -busslaveport  bport1 -loaddress 0x1e00a000 -hiaddress 0x1e00afff
...
ihwconnect -bus pBus -instancename nor0 -busslaveport flash -loaddress 0x40000000 -hiaddress 0x43ffffff
...
ihwconnect -bus pBus -instancename nor1 -busslaveport flash -loaddress 0x44000000 -hiaddress 0x47ffffff
mapNonSecure nor1NS 0x44000000 0x04000000

# 0x48000000    0x4bffffff  RAM CS2: SRAM
ihwaddmemory -instancename sram1  -type ram
ihwconnect -bus pBus -instancename sram1 -busslaveport sp1 -loaddress 0x48000000 -hiaddress 0x4bffffff
mapNonSecure sram1NS 0x48000000 0x04000000

# 0x4c000000    0x4c7fffff  RAM Video RAM
ihwaddmemory -instancename vram1  -type ram
ihwconnect -bus pBus -instancename vram1 -busslaveport sp1 -loaddress 0x4c000000 -hiaddress 0x4c7fffff
...
ihwconnect       -instancename eth0 -bus pBus -busslaveport  bport1 -loaddress 0x4e000000 -hiaddress 0x4e000fff
...
ihwconnect       -instancename usb0 -bus pBus  -busslaveport  bport1 -loaddress 0x4f000000 -hiaddress 0x4f00ffff
...
ihwconnect -bus pBus    -instancename ddr2RamBridge -busslaveport  sp -loaddress 0x60000000 -hiaddress 0x9fffffff
...
ihwconnect -bus pBus    -instancename ddr2RemapBridge -busslaveport sp1 -loaddress 0x00000000 -hiaddress 0x03ffffff
