...
imodeladdbusslaveport -name bport1 -size 0x40  -mustbeconnected
imodeladdaddressblock -name ab     -size 0x40  -port bport1 -width 8

#
# Import 16550 base functions
#
# align the standard 16550 registers on word boundaries
set REGISTERALIGN 4
