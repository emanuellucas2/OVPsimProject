...
FILE:Imperas/Examples/SimulationControl/loadingApplicationProgramBinaryFormatFile/README.txt
...
1. An application; this is found as
        ...
        b) a Makefile to build an ELF and BIN file; application/Makefile
...
program is used to generate a Binary file. 
...
Instead this example terminates after executing 100 instructions. The 
assembler program executes a wfi at which point the simulator detects no 
further instructions will be executed and terminates.
...
A semihost library to terminate simulation on exit can be loaded using
the command line argument
   --extlib ovpworld.org/modelSupport/imperasExit/1.0
