...
FILE:Imperas/Examples/SimulationControl/simplePlatformInHarnessUsingOP/README.txt
...
2. A Harness; 
    harness/harness.c       a harness in C using OP that includes creating the platform
