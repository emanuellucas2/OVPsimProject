...
The example illustrates the use of a test harness to control the save
and restore of a processor and its local memory used for the purpose of
verification of the processor model save/restore capabilities 
