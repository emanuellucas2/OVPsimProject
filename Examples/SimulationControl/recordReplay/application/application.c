...
int main(int argc, char **argv) {
    ...
    printf ("[application]  Reading from uart [type 'x' to exit']\n\n");
    writeMessFreescaleKinetisUart (UART0_BASE, "Reading from UART.\nType chars. [type 'x' to exit']\n\n");
    ...
    while ((c = uart_getchar ()) != 0) {
        ...
        char s[] = {c, '\0'};
        writeMessFreescaleKinetisUart (UART0_BASE, s);
    }
    return 0;
}
