...
#
ihwnew -name packetnetInterface
...
ihwconnect -bus mainBus -instancename prog  -busslaveport sp1 -loaddress 0          -hiaddress 0x0000ffff

ihwaddmemory -instancename stack -type ram
ihwconnect -bus mainBus -instancename stack -busslaveport sp1 -loaddress 0xffff0000 -hiaddress 0xffffffff
...
#
ihwconnect -bus mainBus -instancename pktModel1 -busslaveport  bport1 -loaddress 0x80000000 -hiaddress 0x80000000
ihwconnect -bus mainBus -instancename pktModel2 -busslaveport  bport1 -loaddress 0x80000010 -hiaddress 0x80000010

#
# The packetnet interconnect
#
ihwaddpacketnet -instancename packetbus1

#
# connect the peripherals to the packetnet
#
ihwconnect -packetnet packetbus1 -instancename pktModel1 -packetnetport pktPort
ihwconnect -packetnet packetbus1 -instancename pktModel2 -packetnetport pktPort

#
# create and name the packetnet ports
#
ihwaddpacketnetport -instancename pktnetPort

#
# connect the net ports to the nets
#
ihwconnect -packetnetport  pktnetPort -packetnet packetbus1
