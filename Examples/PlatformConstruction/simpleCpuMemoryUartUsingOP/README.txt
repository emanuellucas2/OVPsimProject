...
FILE:Imperas/Examples/PlatformConstruction/simpleCpuMemoryUartUsingOP/README.txt
...
2. A Module; 
    module/module.c       the module description in C using OP
3. A test harness;
    harness/harness.c     instances the module
