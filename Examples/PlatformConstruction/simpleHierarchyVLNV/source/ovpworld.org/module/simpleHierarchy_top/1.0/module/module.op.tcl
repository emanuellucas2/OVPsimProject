...
# ihwaddmodule  -instancename sub0 -modelfile ovpworld.org/module/simpleHierarchy_sub/1.0/module/model
ihwaddmodule  -instancename sub0 \
	-vendor ovpworld.org -library module -version 1.0 -type simpleHierarchy_sub
...
#ihwaddmodule  -instancename sub1 -modelfile ovpworld.org/module/simpleHierarchy_sub/1.0/module/model
ihwaddmodule  -instancename sub1 \
	-vendor ovpworld.org -library module -version 1.0 -type simpleHierarchy_sub
