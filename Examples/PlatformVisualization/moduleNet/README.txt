...
This example is based on Examples\PlatformConstruction\processorExternalInterrupt
and illustrates the visualization of an LED on a net.

Building the Executables
    A shell script (example.sh/.bat) that is included that runs the provided
    Makefiles to compile up the objects and application. This requires
