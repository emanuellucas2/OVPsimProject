...
This directory contains an example of accessing the information
required to model the ARM TrustZone AxPROT bits in an Imperas
platform implementing internal memory and memory watch callbacks.

This example can only be run on a simulator supporting the security
extensions. 
