...
static OR1K_MORPH_FN(morphBinopRRC) {
    ...
    vmimtBinopRRC(OR1K_BITS, op, rd, ra, c, 0);
}
...
const or1kMorphAttr or1kMorphTable[OR1K_IT_LAST+1] = {
    ...
    [OR1K_IT_ADDI]  = {morphCB:morphBinopRRC, binop:vmi_ADD },
    [OR1K_IT_ADDIC] = {morphCB:morphBinopRRC, binop:vmi_ADC },
    [OR1K_IT_ANDI]  = {morphCB:morphBinopRRC, binop:vmi_AND },
    [OR1K_IT_ORI]   = {morphCB:morphBinopRRC, binop:vmi_OR  },
    [OR1K_IT_XORI]  = {morphCB:morphBinopRRC, binop:vmi_XOR },
    [OR1K_IT_MULI]  = {morphCB:morphBinopRRC, binop:vmi_IMUL},
};
