...
iadddocumentation  \
    -name Description  \
    -text "Simple PSE adding local item"
...
imodeladdmmregister -addressblock bport/reg -name local -width 32 \
    -offset 0 -access rw -readfunction ReadLocal -writefunction WriteLocal
