...
FILE:Imperas/Examples/HelloWorld/usingHarnessExe/README.txt

INTRODUCTION -------------------------------------------------------
This directory contains a very simple example of a CPU and Memory as a module
and uses the provided harness.exe program to simulate it.
