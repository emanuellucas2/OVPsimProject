...
FILE:Imperas/Examples/HelloWorld/usingHarnessInC/README.txt

INTRODUCTION -------------------------------------------------------
This directory contains a simple example to show the use of C harness
to control a simulation of a simple module and application.
...
3. A harness;
    harness/module.c           the C code to instance a module and simulate
